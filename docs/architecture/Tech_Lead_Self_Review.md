...
**判讀：可開學使用；先以單班、受控教室方式運作。**

已確認 8/31 的聯絡簿、次日繳交日、名冊、值日／午餐工作與大屏資料均可用。最大的非程式阻擋不是功能缺失，而是兩項規則風險：大屏的公開寫入，以及讀報／心得在當月第一天就可能成為封鎖下課／商店的欠繳。前者是既有「大屏不用登入」決策的代價；後者應在正式開放欠繳封鎖前確認是否要改成只追蹤已結束月份。
